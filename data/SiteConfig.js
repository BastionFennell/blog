module.exports = {
  ...
  siteDescription:
    "A simple blog about simple frontend programming. Focused on Javascript and React.", // Website description used for RSS feeds/meta description tag.
  siteCover:
  ...
  siteRssAuthor: "Bastion", // The author name used in the RSS file
  // siteFBAppID: "1825356251115265", // optional, sets the FB Application ID for using app insights
  sitePaginationLimit: 10, // The max number of posts per page.
  // googleAnalyticsID: "UA-111982167-1", // GA tracking ID.
  // disqusShortname: "https-vagr9k-github-io-gatsby-advanced-starter", // enables Disqus comments, visually deviates from original Casper theme.
  siteSocialUrls: [
    "https://github.com/BastionFennell",
    "https://twitter.com/BastionTheDev",
    "mailto:bastionthedev@example.com"
  ],
  ...
  userLinks: [
    {
      label: "GitHub",
      url: "https://github.com/BastionFennell",
      iconClassName: "fa fa-github" // Disabled, see Navigation.jsx
    },
    {
      label: "Twitter",
      url: "https://twitter.com/BastionTheDev",
      iconClassName: "fa fa-twitter" // Disabled, see Navigation.jsx
    },
    {
      label: "Email",
      url: "mailto:bastionthedev@example.com",
      iconClassName: "fa fa-envelope" // Disabled, see Navigation.jsx
    }
  ],
  // Copyright string for the footer of the website and RSS feed.
  copyright: {
    label: "Bastion Fennell" // Label used before the year
